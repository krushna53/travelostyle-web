  ...
  return (
    ...
    <section className="min-[1024px]:hidden px-5 pt-[93px] min-[768px]:pt-8 pb-10">
      <div className="relative">
        ...
        <h1 className="font-taprom text-[40px] max-[1910px]:text-[35px] max-[1281px]:text-[35px] max-[1250px]:text-[32px] max-[1200px]:text-[32px] z-0 relative leading-[48px] tracking-[0.05em] text-black flex flex-col items-start gap-[8px]">
