...
export default function TravelBetter() {
  const cardClass =
    "rounded-[10px] border-[2px] border-[#2C3078] p-[24px] min-[1024px]:p-[16px] w-full max-w-[337px] h-[209px] mx-auto flex flex-col min-[1024px]:max-w-none min-[1024px]:h-[209px]";

  return (
    <section className="relative px-4 min-[768px]:px-[60px] min-[1024px]:px-[113px] pt-[60px] min-[768px]:pt-[100px] min-[1024px]:pt-[140px] pb-[60px] min-[1024px]:pb-[120px] overflow-hidden">
      {/* Curve Line — desktop */}
      <Image
        src="/Vector 222.svg"
        alt=""
        width={1400}
        height={900}
        className="hidden min-[1024px]:block absolute left-0 top-0 w-full h-full object-cover z-0 pointer-events-none"
      />
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="min-[1024px]:hidden pointer-events-none absolute right-[-20px] top-[-5px] w-[280px] h-auto z-0"
      />

      <div className="relative z-10 max-w-[530px]">
        <p className="font-taprom text-[48px] max-[1910px]:text-[43px] max-[1281px]:text-[38px] max-[1250px]:text-[33px] max-[1200px]:text-[28px] font-normal leading-[32px] min-[1024px]:leading-[64px] tracking-[0.05em] text-black [text-box-trim:cap] [text-box-edge:cap_alphabetic]">
          ways we like to travel
        </p>

        <h2 className="mt-3 text-[48px] max-[1910px]:text-[43px] max-[1281px]:text-[38px] max-[1250px]:text-[33px] max-[1200px]:text-[28px] font-bold leading-[40px] tracking-[0.05em] text-black [text-box-trim:cap] [text-box-edge:cap_alphabetic] w-[292px] min-[768px]:w-auto">
      ...
      <div className="relative z-10 mt-[40px] min-[768px]:mt-[70px]">
        ...
        <div className="mt-5 grid grid-cols-1 min-[640px]:grid-cols-2 min-[1024px]:grid-cols-4 gap-5 min-[768px]:gap-8 min-[1024px]:gap-x-[24px] min-[1024px]:gap-y-[24px] items-center">
          ...
          <div className="min-[640px]:col-span-2 min-[1024px]:col-span-2 pt-6 min-[1024px]:pt-2">
            <p className="font-taprom font-normal text-[45px] max-[1910px]:text-[40px] max-[1281px]:text-[35px] max-[1250px]:text-[30px] max-[1200px]:text-[25px] leading-[56px] tracking-normal text-[#000000] max-w-[345px] min-[768px]:max-w-none">
