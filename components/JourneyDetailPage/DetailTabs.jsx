 ...
 console.log("DETAIL TABS INCLUSIONS", inclusions);
  ...
  return (
    ...
    <div ref={containerRef} className="bg-white hidden md:block">
      <div className="sticky top-0 z-20 bg-[#FAFAFA] border-b border-[#E5E5E5] shadow-[0_6px_16px_-6px_rgba(0,0,0,0.15)] flex items-center h-[78px] px-[20px] max-[901px]:h-[64px] max-[901px]:px-[20px] max-[1200px]:h-[68px] max-[1200px]:px-[26px] max-[1250px]:h-[72px] max-[1250px]:px-[32px] max-[1281px]:h-[74px] max-[1281px]:px-[38px] max-[1910px]:h-[78px] max-[1910px]:px-[48px] min-[1919px]:h-[80px] min-[1919px]:px-[64px]">
        <div className="flex items-center w-full h-full overflow-x-auto [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden gap-x-[10px] max-[901px]:gap-x-[4px] max-[1200px]:gap-x-[8px] max-[1250px]:gap-x-[10px] max-[1281px]:gap-x-[12px] max-[1910px]:gap-x-[16px] min-[1919px]:gap-x-[18px] justify-between pl-[48px] max-[901px]:pl-[48px] max-[1200px]:pl-[56px] max-[1250px]:pl-[64px] max-[1281px]:pl-[70px] max-[1910px]:pl-[76px] min-[1919px]:pl-[80px]">
          {tabs.map((tab) => (
            <button
              ...
              className={`relative shrink-0 px-[6px] max-[901px]:px-[6px] max-[1200px]:px-[10px] max-[1250px]:px-[12px] max-[1281px]:px-[14px] max-[1910px]:px-[18px] min-[1919px]:px-[22px] py-[18px] max-[901px]:py-[6px] max-[1200px]:py-[10px] max-[1250px]:py-[13px] max-[1281px]:py-[15px] max-[1910px]:py-[18px] min-[1919px]:py-[21px] whitespace-nowrap  leading-[1.5] tracking-[0.05em] transition-colors max-[901px]:tracking-normal text-[19px] max-[901px]:text-[11px] max-[1200px]:text-[15px] max-[1250px]:text-[16px] max-[1281px]:text-[18px] max-[1910px]:text-[19px] min-[1919px]:text-[21px] ${
                ...
                activeTab === tab
                  ...
                  : "font-light text-black hover:text-black/80"
              }`}
            >
              {tab}
              {activeTab === tab && (
                <span className="absolute bottom-[8px] left-0 right-0 h-[5px] bg-black" />
              )}
            </button>
          ))}
        </div>
